...
function getSupabaseEnv() {
    const url = ("TURBOPACK compile-time value", "https://bjfkztzlwnkaqbyufcsz.supabase.co");
    const key = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJqZmt6dHpsd25rYXFieXVmY3N6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM0NjQzNzMsImV4cCI6MjA4OTA0MDM3M30.ChTpG8zYmCJHjYGJl8sXB5kcnaETnH7baa26RK_UMGY");
...
"[project]/src/app/portal/register/register-form.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        try {
            ...
            if (signUpError) {
                ...
                if (msg.includes("rate limit") || msg.includes("ratelimit")) {
                    setError("Too many sign-up attempts. Supabase limits how often you can register. Please wait an hour and try again, or use a different email.");
                } else {
...
"[project]/src/app/portal/register/complete-registration-form.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab248fda._.js.map