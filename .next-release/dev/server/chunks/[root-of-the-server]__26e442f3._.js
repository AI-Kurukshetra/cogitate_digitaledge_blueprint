...
"[project]/src/app/api/admin/policyholders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data, error } = await supabase.from("policyholders").select("id, full_name, email, state").order("full_name");
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__26e442f3._.js.map